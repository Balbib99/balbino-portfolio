...
export const es = {
  ...
  buttons: {
    ...
    technicalDetails: "ver caso de estudio",
  },
  hero: {
  ...
  about: {
    ...
    cards: aboutCards,
    lead: "¡Hola! Soy Balbino, desarrollador full-stack. Más de 2 años de experiencia en I+D e integración hardware-software.",
    more: "saber más sobre mí",
    profileTitle: "perfil",
    storyTitle: "la historia",
    valueTitle: "lo que aporto",
    focusTitle: "dónde me muevo",
  ...
  contact: {
    ...
    form: {
      ...
      submitDirect: "Enviar mensaje",
      sending: "Enviando...",
      help: "Se abrirá tu aplicación de correo con el mensaje preparado antes de enviarlo.",
      helpDirect: "Tu mensaje se envía directamente, sin necesidad de abrir tu aplicación de correo.",
      success: "¡Mensaje enviado! Te responderé lo antes posible.",
      submitError: "No se pudo enviar el mensaje. Inténtalo de nuevo o escríbeme directamente por email.",
