...
export const Contact = () => {
  ...
  return (
    <section
      id="contacto"
      className="bg-slate-950 px-4 py-20 text-white dark:bg-[radial-gradient(circle_at_top_left,rgba(20,184,166,0.1),transparent_30%),#070b14] sm:px-6 lg:px-8"
    >
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_0.85fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300">{t.contact.description}</p>
        </div>
