...
export const ExperienceCard = ({ experience }: ExperienceCardProps) => (
  <article className="rounded-lg border border-slate-200 bg-white p-6 shadow-soft transition duration-200 hover:-translate-y-1 hover:border-teal-200 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-teal-700">
    ...
    <div className="mt-6">
      <h4 className="text-sm font-bold uppercase tracking-[0.14em] text-slate-700 dark:text-slate-200">Responsabilidades</h4>
    ...
    <div className="mt-6">
      <h4 className="text-sm font-bold uppercase tracking-[0.14em] text-slate-700 dark:text-slate-200">Tecnologías y áreas</h4>
    ...
    <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-950/40">
      <h4 className="text-sm font-bold uppercase tracking-[0.14em] text-teal-700 dark:text-teal-300">Valor aportado</h4>
