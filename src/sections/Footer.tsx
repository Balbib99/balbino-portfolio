...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-slate-200 bg-paper px-4 py-8 dark:border-white/10 dark:bg-[#070b14] sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 text-sm text-slate-600 dark:text-slate-300 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-4">
          <a
            className="font-semibold hover:text-teal-700 focus-visible:text-teal-700 dark:hover:text-teal-300 dark:focus-visible:text-teal-300"
            href={links.github}
            target="_blank"
