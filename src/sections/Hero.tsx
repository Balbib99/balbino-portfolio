...
export const Hero = () => {
  ...
  <section id="inicio" className="relative overflow-hidden">
    <div className="absolute inset-0 -z-10 bg-[linear-gradient(135deg,#f8fafc_0%,#eef6f8_48%,#f8fafc_100%)] dark:bg-[radial-gradient(circle_at_top_left,rgba(20,184,166,0.12),transparent_32%),linear-gradient(135deg,#070b14_0%,#0b1220_54%,#101827_100%)]" />
