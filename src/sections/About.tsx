        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
            {t.about.cards.map((card) => (
              <article
                key={card.title}
                className="rounded-lg border border-slate-200 bg-paper-muted p-5 transition duration-200 hover:-translate-y-1 hover:border-teal-200 hover:bg-white dark:border-white/10 dark:bg-white/[0.045] dark:hover:border-teal-400/35 dark:hover:bg-white/[0.07]"
              >
